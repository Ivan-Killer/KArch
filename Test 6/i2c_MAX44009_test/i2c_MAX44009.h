...
class MAX44009 : public i2cSensor
{
  ...
  private:
    ...
    //static const uint8_t    I2C_ADDRESS 				    = (0x4A); //was 0x4B /// depends on configuration of the sensor
  ...
  public:
    ...
    inline void setEnabled(uint8_t& I2C_ADDRESS, const uint8_t enable = 1) // added uint8_t I2C_ADDRESS
    {
      uint8_t _value;
      if (enable)
      {
    ...
    inline uint8_t initialize(uint8_t& I2C_ADDRESS) // added uint8_t I2C_ADDRESS
    {
      if (i2c.probe(I2C_ADDRESS) == 0) return 0;

      setEnabled(I2C_ADDRESS, 1);
      return 1;
    };
    ...
    */
    inline void getMeasurement(uint8_t& I2C_ADDRESS, uint32_t& mLux_value) // added uint8_t I2C_ADDRESS
    {
