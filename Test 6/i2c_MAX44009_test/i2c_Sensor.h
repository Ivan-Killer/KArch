...
public:
    ...
    virtual void    setEnabled(uint8_t& I2C_ADDRESS, const uint8_t enable=1) = 0;  // added uint8_t I2C_ADDRESS    // Enable Sensor or set it to Standby (1 or 0)

    virtual void    reset(void) = 0;                    // trigger a software-reboot of the sensor

    virtual uint8_t initialize(uint8_t& I2C_ADDRESS) = 0;  // added uint8_t I2C_ADDRESS              // set up the sensor for basic operation, IF found at address
